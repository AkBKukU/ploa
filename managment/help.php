        ...
        <div id="helppage" class="textarea">
            ...
            <hr />
            <h3 id="textplace"><a href="#textplace">Placement</a></h3>
            <p>With these you can add styling such as being bold to your text when you post.</p>
            ...
            <hr />
            <h3 id="textsize"><a href="#textsize">Size</a></h3>
            ...
            <hr />
            <h3 id="textcolor"><a href="#textcolor">Color</a></h3>
            <p>With these you can add some color to your post.</p>
            ...
            <hr />
            <h3 id="textwidth"><a href="#textwidth">Width</a></h3>
            <p>With these you can add styling such as being bold to your text when you post.</p>
